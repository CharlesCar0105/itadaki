...
public class RagService {
    ...
    private Map<String, double[]> getNutritionTable() {
        return Map.ofEntries(
                ...
                Map.entry("maïs",                       new double[]{ 86,  3.2,  1.2, 19.0}),
                Map.entry("petits pois",                new double[]{ 81,  5.4,  0.4, 14.5}),
                Map.entry("haricots verts",             new double[]{ 31,  1.8,  0.2,  7.1}),
                ...
                Map.entry("fromage râpé",               new double[]{400, 25.0, 33.0,  1.3}),
                Map.entry("fromage fondu",              new double[]{310, 15.0, 27.0,  2.0}),
                Map.entry("oeuf dur",                   new double[]{155, 13.0, 11.0,  1.1}),
                // Sauces & matières grasses
                Map.entry("sauce soja",                 new double[]{ 60,  8.0,  0.1,  5.6}),
                Map.entry("sauce tomate",               new double[]{ 40,  1.5,  0.5,  8.0}),
                Map.entry("sauce bolognaise",           new double[]{120,  8.0,  7.0,  7.0}),
                Map.entry("béchamel",                   new double[]{120,  4.0,  8.0,  8.0}),
                Map.entry("sauce curry",                new double[]{ 95,  3.0,  6.0,  7.0}),
                Map.entry("sauce fromagère",            new double[]{150,  5.0, 12.0,  5.0}),
                Map.entry("sauce barbecue",             new double[]{172,  1.5,  0.5, 42.0}),
                Map.entry("crème fraîche",              new double[]{300,  2.5, 30.0,  3.0}),
                Map.entry("crème liquide",              new double[]{335,  2.0, 35.0,  3.0}),
                Map.entry("mayonnaise",                 new double[]{680,  1.0, 75.0,  1.0}),
                Map.entry("ketchup",                    new double[]{112,  1.3,  0.1, 27.0}),
                Map.entry("moutarde",                   new double[]{ 66,  4.4,  3.3,  5.3}),
                Map.entry("vinaigrette",                new double[]{450,  0.5, 48.0,  4.0}),
                Map.entry("huile d'olive",              new double[]{884,  0.0,100.0,  0.0}),
                Map.entry("pesto",                      new double[]{410,  5.0, 40.0,  5.0}),
                // Légumineuses
                Map.entry("lentilles",                  new double[]{116,  9.0,  0.4, 20.0}),
                Map.entry("pois chiches",               new double[]{164,  9.0,  2.6, 27.0}),
                Map.entry("haricots rouges",            new double[]{127,  8.7,  0.5, 22.8}),
                Map.entry("tofu",                       new double[]{ 76,  8.0,  4.5,  1.9}),
